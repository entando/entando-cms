...
export const getContentType = (contentTypeCode) =>
  makeRequest({
...
export const postContentType = (contentTypeObject) =>
  makeRequest({
    uri: contentTypePath,
...
export const putContentType = (contentTypeObject) =>
  makeRequest({
    uri: contentTypePath,
    body: contentTypeObject,
    method: METHODS.PUT,
...
export const deleteContentType = (contentTypeCode) =>
  makeRequest({
    uri: `${contentTypePath}/${contentTypeCode}`,
...
export const getContentTypesStatus = () =>
  makeRequest({
...
export const postContentTypesStatus = (contentTypeCodes) =>
  makeRequest({
    uri: `${contentTypePath}Status`,
    method: METHODS.POST,
...
export const postRefreshContentType = (contentTypeCode) =>
  makeRequest({
...
export const getAttributeFromContentType = (contentTypeCode, attributeCode) =>
  makeRequest({
...
export const postAttributeFromContentType = (contentTypeCode, attributeObject) =>
  makeRequest({
...
export const putAttributeFromContentType = (contentTypeCode, attributeObject) =>
  makeRequest({
...
export const deleteAttributeFromContentType = (contentTypeCode, attributeCode) =>
  makeRequest({
    uri: `${contentTypePath}/${contentTypeCode}/attributes/${attributeCode}`,
    method: METHODS.DELETE,
...
export const getContentTypeAttributes = (page = { page: 1, pageSize: 10 }, params = '') =>
  makeRequest(
    {
...
export const getContentTypeAttribute = (attributeTypeCode) =>
  makeRequest({
...
export const moveAttributeUp = (contentTypeCode, attributeCode) =>
  makeRequest({
...
export const moveAttributeDown = (contentTypeCode, attributeCode) =>
  makeRequest({
