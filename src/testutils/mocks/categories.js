export const HOME_PAYLOAD = {
  ...
  children: ['mycategory1', 'mycategory2', 'mycategory3'],
};
...
export const GET_SELENIUM_CATEGORY_RESPONSE_OK = {
  ...
  parentCode: 'home',
  titles: {
    en: 'SeleniumTest_DontTouch',
    it: 'SeleniumTest_DontTouch',
  },
  fullTitles: {
    en: 'Root / SeleniumTest_DontTouch',
    it: 'Generale / SeleniumTest_DontTouch',
  },
  children: [],
  references: {},
};
