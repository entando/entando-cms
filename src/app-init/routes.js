...
export const ROUTE_CMS_CONTENT_TYPE_ATTRIBUTE_EDIT =
  '/content-type/attribute/:entityCode/edit/:attributeCode';
export const ROUTE_CMS_CONTENT_TYPE_ATTRIBUTE_MONOLIST_ADD =
  '/content-type/attribute/:entityCode/MonolistAdd/:attributeCode';
