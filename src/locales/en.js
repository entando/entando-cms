export default {
  ...
  messages: {
    ...
    'cms.assets.tip': 'The ASSETS section section allows you to add, delete existing resources, images and attachments that can be used within web content components.',
