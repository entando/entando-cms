export default {
  ...
  messages: {
    ...
    'cms.assets.tip': 'The DIGITAL ASSETS section allows you to add, delete existing resources, images and attachments that can be used within web content components.',
