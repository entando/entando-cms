export default {
  ...
  messages: {
    ...
    'cms.assets.tip': 'The ASSETS section lets you manage existing resources, images and attachements, access resources list, add or delete resources.  Images and attachments can be uploaded to a digital assets archive and used in content.',
    ...
    'cms.contenttemplate.form.nameHelp': 'You can insert up to 50 characters including upper and lowercase letters, numbers and special characters',
    'cms.contenttemplate.form.contentTypeHelp': 'Choose one of your existing content types to use for your content template',
    'cms.contenttemplate.form.htmlmodel': 'HTML Model',
    'cms.contenttemplate.form.htmlmodelHelp': 'This will be your HTML content structure using your content elements provided by given content type',
    ...
    'cms.contenttemplate.form.htmlmodel.statusadminconf': 'If you want to change the status, you should set them in Admin Configuration Area',
    ...
    'cms.contenttype.reference.text': 'Reload the references for these entity types: {types}. Number of type to reload: {count}. ',
    ...
    'cms.contentsettings.label.reloadstatus.remark.failed': 'Last reload in {date}, went wrong',
    ...
    'cms.contents.edit.groups.ownerGroup.tooltip': 'You should set the Main group right now, or some things will get sketchy.',
    ...
    'cms.contents.edit.contentDescription.tooltip': 'Provide a description or I will use the title if available.',
    'cms.contents.edit.contentDescription.placeholder': 'Descriptions help you archive, sort, and find contents',
    ...
    'cms.contents.edit.titletip': 'The CONTENTS section lets you manage existing contents, access contents list, add new contents. You can also approve, suspend, or delete contents. In Entando, a Content is a structured element that represents a set of information built using Content Attributes.',
