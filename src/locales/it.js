export default {
  ...
  messages: {
    ...
    'cms.label.from': 'Da',
    'cms.label.to': 'A',
    'cms.versioning.restore.versionRestored': '{version} restaurato',
    ...
    'cms.versioning.resource.imageCaption': 'Recupera Immagine',
    'cms.versioning.resource.fileCaption': 'Ripristina Allegato',
    'cms.versioning.resource.imagePrompt': 'Vuoi recuperare l\'immagine "{name}"?',
    'cms.versioning.resource.filePrompt': 'Vuoi recuperare l\'allegato "{name}"?',
    'cms.versioning.resource.infoRecovered': 'La risorsa "{name}" è stata recuperata.',
    ...
    'widget.singleContent.config.title': 'Contenuti - Pubblica un contenuto',
