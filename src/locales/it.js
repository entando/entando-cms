export default {
  ...
  messages: {
    ...
    'cms.menu.contenttemplates': 'Template di Contenuto',
    ...
    'cms.assets.list.nothingFound': 'Nessuna risorsa digitale disponibile',
    'cms.assets.list.of': 'di',
    'cms.assets.list.items': 'elementi',
    'cms.assets.label.assetbrowser': 'Sfogliare le Risorse',
    ...
    'cms.assets.errors.failedToUpload': 'Caricamento dell\'asset non riuscito a causa di un errore del server',
    ...
    'cms.versioning.list.description': 'Descrizione',
    ...
    'cms.contenttemplate.add.label': 'Aggiungere',
    'cms.contenttemplate.edit.label': 'Modificare',
    ...
    'cms.contenttype.reference.text': "Le referenze per i seguenti Tipi di Entita' hanno bisogno di essere ricaricate: {types}. Totale da ricaricare: {count}. ",
    ...
    'cms.content.status.published': 'Approvato',
    'cms.content.status.unpublished': 'Lavoro',
    'cms.content.status.ready': 'Approvato, con modifiche',
    ...
    'cms.contents.ready': 'Pronto',
    'cms.contents.toApprove': 'da Approvare',
    ...
    'widget.form.settings': 'Impostazione',
    'widget.form.order': 'Ordinare',
