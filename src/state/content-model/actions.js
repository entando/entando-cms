...
export const fetchContentModelListPaged = (page = { page: 1, pageSize: 10 }, params = '') => (
  dispatch,
) =>
  new Promise((resolve) => {
...
export const sendPostContentModel = (contModelObject) => (dispatch) =>
  new Promise((resolve) =>
    postContentModel(contModelObject)
      .then((response) => {
        response.json().then((json) => {
          if (response.ok) {
...
export const fetchContentModel = (id) => (dispatch) =>
  new Promise((resolve) =>
    getContentModel(id)
      .then((response) => {
        response.json().then((json) => {
...
export const sendPutContentModel = (contModelObject) => (dispatch) =>
  new Promise((resolve) =>
    putContentModel(contModelObject)
      .then((response) => {
        response.json().then((json) => {
          if (response.ok) {
            resolve(json.payload);
...
export const sendDeleteContentModel = (id) => (dispatch) =>
  new Promise((resolve) =>
    deleteContentModel(id)
      .then((response) => {
        response.json().then((json) => {
          if (response.ok) {
            resolve(json.payload);
