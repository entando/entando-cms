...
// thunks
export const fetchContentTypeListPaged = (page = { page: 1, pageSize: 10 }, params = '') => (
  dispatch,
) =>
  new Promise((resolve) => {
...
export const fetchContentTypeReferenceStatus = () => (dispatch) =>
  new Promise((resolve) => {
    getContentTypesStatus()
      .then((response) => {
        response.json().then((json) => {
...
export const sendPutContentType = (contentTypeObject) => (dispatch) =>
  new Promise((resolve) =>
    putContentType(contentTypeObject)
      .then((response) => {
        response.json().then((json) => {
          if (response.ok) {
            resolve(json);
