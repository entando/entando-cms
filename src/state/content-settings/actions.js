...
export const fetchContentSettings = () => (dispatch) =>
  new Promise((resolve) => {
...
export const sendPutEditorSettings = (editor) => (dispatch) =>
  new Promise((resolve) => {
...
export const addCropRatio = (cropRatio) => (dispatch) =>
  new Promise((resolve) => {
...
export const sendPostMetadataMap = (key, mapping) => (dispatch) =>
  new Promise((resolve) => {
...
export const removeCropRatio = (cropRatio) => (dispatch, getState) =>
  new Promise((resolve) => {
...
export const updateCropRatio = (cropRatio, newValue) => (dispatch) =>
  new Promise((resolve) => {
...
export const sendPutMetadataMap = (key, mapping) => (dispatch) =>
  new Promise((resolve) => {
...
export const checkAndPutMetadataMap = (values) => (dispatch, getState) =>
  new Promise((resolve) => {
...
export const sendDeleteMetadataMap = (key) => (dispatch) =>
  new Promise((resolve) => {
