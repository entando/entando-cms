...
export const getReferenceKeyList = (state) =>
  get(state.apps.cms.categories, 'selected.referenceKeyList', []);
export const getReferenceMap = (state) =>
  get(state.apps.cms.categories, 'selected.referenceMap', {});
