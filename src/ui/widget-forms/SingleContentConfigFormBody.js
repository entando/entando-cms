...
import ContentSelectedTableRenderer from 'ui/widget-forms/ContentTableRenderer';
...
export default class SingleContentConfigFormBody extends PureComponent {
  ...
  render() {
    const {
      ...
      widgetCode,
      chosenContents,
      dirty, onCancel, onDiscard,
      showFilterModal, onSelectContent,
    } = this.props;
      ...
      <Fragment>
        <form onSubmit={handleSubmit} className="form-horizontal">
          <Row>
            <Col xs={12}>
              <FieldArray
                component={ContentSelectedTableRenderer}
