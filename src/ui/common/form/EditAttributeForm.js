...
export class EditAttributeFormBody extends Component {
  ...
  render() {
    const {
      ...
      nestedAttributeComposite, isSearchable, isIndexable, attributesList,
      onSubmit, allowedRoles, handleSubmit, invalid, submitting,
    } = this.props;
      ...
      >
        ...
        <Row>
          <Col xs={12}>
            ...
            >
              {
              !isComposite ? <FormattedMessage id="cms.label.continue" /> : <FormattedMessage id="cms.label.save" />
              }
            </Button>
          </Col>
        </Row>
